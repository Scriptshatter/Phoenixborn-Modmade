...
public class Items {
    ...
    public static final Phoenix_pickaxe PHOENIX_PICKAXE = register_API_items("phoenix_pickaxe", new Phoenix_pickaxe(new Charged_amethyst_mat(), 2, -1f, new FabricItemSettings(), 150), Phoenix.MOD_ID);
